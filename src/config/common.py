...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '#p7&kxb7y^yq8ahfw5%$xh=f8=&1y*5+a5($8w_f7kw!-qig(j')
ALLOWED_HOSTS = ["*"]
...
EMAIL_FROM = os.environ.get('EMAIL_FROM', 'noreply@somehost.local')
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_PASSWORD', 'noreply@somehost.local')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'asdf.1234')
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': int(os.environ.get('DJANGO_PAGINATION_LIMIT', 18)),
